# Django settings for GifBiscuit project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'GitBiscuit.sqlite',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/Users/josephredfern/Development/Django/GifBiscuit/gif/templates",
)
